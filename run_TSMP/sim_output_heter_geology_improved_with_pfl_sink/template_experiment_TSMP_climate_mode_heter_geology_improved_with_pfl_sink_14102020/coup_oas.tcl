...
#---------------------------------------------------------
 ...
 pfset GeomInput.solidinput.FileName   /p/project/cjibg35/jibg3501/forcings/testdata_EU_std/ParFlow/geom_cordex0.11_436x424.pfsol
...
#changed Geom.domain.Perm.TensorValX from 1000.0->1->1000.0 LPo 14.10.2020
pfset Geom.domain.Perm.TensorValX	 1000.0 
#changed Geom.domain.Perm.TensorValY from 1000.0->->11000.0 LPo 14.10.2020
...
#-----------------------------------------------------------------------------
pfwritedb cordex0.11___year_____month__
